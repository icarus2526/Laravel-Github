...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <title>Laravel on GitHub</title>

    <link href="https://fonts.googleapis.com/css?family=Raleway:100,600" rel="stylesheet" type="text/css">
    <!-- Bootstrap -->
    <link href="theme2/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="theme2/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <!--<ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up" style="float: right;"></i></a>
                      </li>
                      <li class="dropdown">
    ...
    <!-- Bootstrap -->
    <script src="theme2/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- FastClick -->
